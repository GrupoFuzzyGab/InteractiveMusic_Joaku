...
PVector[] getUserJoints(int userId) {
  ...
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_HEAD,joints[0]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_NECK,joints[1]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_TORSO, joints[2]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_SHOULDER,joints[3]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_ELBOW,joints[4]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_HAND,joints[5]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_SHOULDER,joints[6]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_ELBOW,joints[7]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_HAND,joints[8]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_HIP,joints[9]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_KNEE,joints[10]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_LEFT_FOOT,joints[11]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_HIP,joints[12]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_KNEE,joints[13]);
  context.getJointPositionSkeleton(userId,SimpleOpenNI.SKEL_RIGHT_FOOT,joints[14]);
 ...
 * @param int jointIDB   eg. SimpleOpenNI.SKEL_LEFT_HAND
...
void sendOSC_jointDistance (int userId, int jointA, int jointB, String url) {
      ...
      context.getJointPositionSkeleton(userId, jointA, jointA_pv);
      context.getJointPositionSkeleton(userId, jointB, jointB_pv);
